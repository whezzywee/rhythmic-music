...
import 'package:rhythmic_music/ui/player/components/backgroud_image.dart';
import 'package:rhythmic_music/utils/ionicons.dart';
    ...
    return Stack(
      children: [
        GestureDetector(
          ...
          child: const BackgroudImage(cacheHeight: 200),
