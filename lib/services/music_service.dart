...
class MusicServices {
  ...
  Future<void> init() async {
    ...
    hlCode = _appPreferences.get('contentLanguage', defaultValue: "en");
    if (_appPreferences.containsKey('visitorId')) {
      final visitorData = _appPreferences.get("visitorId");
      if (visitorData != null && !isExpired(epoch: visitorData['exp'])) {
        _headers['X-Goog-Visitor-Id'] = visitorData['id'];
        _appPreferences.put("visitorId", {
          'id': visitorData['id'],
